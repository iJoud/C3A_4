        ...
        <div class="ParentDiv">
            <div class="SearchDiv">
                ...
                while(i<uniquecity.length){            
                    if (uniquecity[i]!=null){
                                %>
                                <li><input type="radio" name="dropdownCity" value="<%=uniquecity[i]%>"/><span><%=uniquecity[i]%></span></li>
                                        <% }
                                        i++;
                                        } 
                                         } catch (Exception ex) { }
            ...
            <div class="Posts" class="g-4" style="width: 60%">
                ...
                <% 
                    ...
                    // Remove request variables "for filter"
                    request.setAttribute("dropdownCity", null);
                    request.setAttribute("dropdownBloodDonationType", null);
                    request.setAttribute("dropdownBloodType", null);
