...
<html lang="en">
    <head>
        ...
        <link href="Instruction.css" rel="stylesheet"/>
    </head>
    <body id="b">
        <div class="topnav">
            <img id="logo" src="Logo.jpg" alt="logo">
            <a href="Home.html">Home</a>
            <a href="View_Post.html">Donation Requests</a>
        ...
        <div class="container" id="con">
            <div class="row"><!-- First row -->
                <div class="col">
                    <img id="homepagephoto" src="mid.png" alt="homepage" class="floatRight"/>
                </div>
                <div class="col">
            ...
            <div class="row"><!-- Secoond row -->
                ...
                <div class="col">
                    <img id="homepagephoto2" src="miid.png" alt="homepage" class="floatLift"/>

                </div>
            </div>
            <div class="row"><!-- Third row -->
                <div class="col">
                    <img id="homepagephoto" src="midd.png" alt="homepage" class="floatRight"/>
                </div>
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col">
                    <img id="homepagephoto2" src="mmid.png" alt="homepage" class="floatLift"/>
            ...
            <button class="btn2" type="button" onclick="document.location='Home.jsp'">Continue</button>
